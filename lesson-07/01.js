...
Изучите файл index.html. В этом задании надо будет работать с секцией "Урок 6". Разметка уже написана - нужно добавить только js-код.
...
const webTechImageElement = document.getElementById("web-tech-image");
...
nextButton.addEventListener("click",() => {
    ...
    webTechImageElement.src = WEB_TECH_IMAGES[index];
});
